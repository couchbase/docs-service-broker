...
. Register the Service Broker with the platform.
Once the Service Broker is registered with the platform (Kubernetes), users can view the service offerings by listing all the services and service plans provided by different Service Brokers through the service catalog.
