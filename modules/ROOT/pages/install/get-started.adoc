...
[abstract]
This page describes how to get and install the Couchbase Service B roker and create your first service instance.
...
The resulting directory will be titled something like couchbase-service-broker_x.x.x.
...
[source,console]
----
$ ./cbsbctl create clusterservicebroker --profile demo-servicebroker
----
--
...
[source,console]
----
$ ./cbsbctl create clusterservicebroker --profile demo-clusterservicebroker
----
--
====
